...
import { P as PLUGIN_ID, R as RESOLVE_CONFIG } from "./index-aQxRlTvM.mjs";
...
class LinkButton {
  ...
  render() {
    ...
    ReactDOM.render(/* @__PURE__ */ jsx(Btn, { onDataChange, data: this.nodes.data }), rootNode);
    return this.nodes.holder;
  }
  save() {
    return this.nodes.data;
...
function Btn({ onDataChange, data }) {
  const [hasTracking, setHasTracking] = React__default.useState(!!data.trackingLabel);
  const handleChangeValue = (val) => {
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", { style: { fontSize: "12px", marginTop: "8px" }, children: "Knap tekst:" }),
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        id: "text",
              ...
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", { style: { fontSize: "12px", marginTop: "8px" }, children: "Knap link:" }),
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        id: "url",
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("label", { style: { display: "flex", alignItems: "center", cursor: "pointer" }, children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "checkbox",
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("p", { style: { fontSize: "12px" }, children: "Tracking label: " }),
              /* @__PURE__ */ jsx(
                "div",
                {
                  style: {
              ...
              /* @__PURE__ */ jsxs("p", { style: { fontSize: "11px", marginTop: "4px" }, children: [
