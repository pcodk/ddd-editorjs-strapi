...
const index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./Editorjs-BQSnC8GF.js")).then((module2) => ({
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-BoeBC6ZP.js")) }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
